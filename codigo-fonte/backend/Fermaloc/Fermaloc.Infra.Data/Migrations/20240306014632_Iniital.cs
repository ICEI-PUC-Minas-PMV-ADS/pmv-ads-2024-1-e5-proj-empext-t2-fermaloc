        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Banners_Administrators_AdministratorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Administrators_AdministratorId",
                        column: x => x.AdministratorId,
                        principalTable: "Administrators",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Equipaments_Administrators_AdministratorId",
                        column: x => x.AdministratorId,
                        principalTable: "Administrators",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Equipaments_Categories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Banners_AdministratorId",
                table: "Banners",
                column: "AdministratorId");

            migrationBuilder.CreateIndex(
                name: "IX_Categories_AdministratorId",
                table: "Categories",
                column: "AdministratorId");

            migrationBuilder.CreateIndex(
                name: "IX_Equipaments_AdministratorId",
                table: "Equipaments",
                column: "AdministratorId");

            migrationBuilder.CreateIndex(
                name: "IX_Equipaments_CategoryId",
                table: "Equipaments",
                column: "CategoryId");
        }
